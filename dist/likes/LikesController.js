 ...
 */
const findUsersThatLikedTuit = (req, res) => dao
 ...
 */
const findTuitLikesCount = (req, res) => dao.findTuitLikesCount(req.params.tid)
    .then(likes => res.json({ likes }));
/**
 ...
 */
const userLikesTuit = (req, res) => dao.userLikesTuit(req.params.uid, req.params.tid)
 ...
 */
const userUnlikesTuit = (req, res) => dao.userUnlikesTuit(req.params.uid, req.params.tid)
    .then(status => res.json(status));
/**
 ...
 */
exports.default = (app) => {
    app.get("/api/users/:uid/likes", findTuitsUserLiked);
    app.get("/api/tuits/:tid/likes", findUsersThatLikedTuit);
    app.get("/api/tuits/:tid/likes/count", findTuitLikesCount);
    app.post("/api/users/:uid/likes/:tid", userLikesTuit);
    app.delete("/api/users/:uid/likes/:tid", userUnlikesTuit);
};
