 ...
 */
export const userMessagesUser = (message, uid, uid2) => messagesModel
 ...
 * @param uid2 recipient
 */
export const userDeletesMessage = (uid, uid2) => messagesModel
    .deleteOne({ from: uid,
    to: uid2 });
/**
 ...
 * @param uid sender
 */
export const findSentMessages = (uid) => messagesModel
    .find({ from: uid })
 ...
 * @param uid recipient
 */
export const findReceivedMessages = (uid) => messagesModel
    .find({ to: uid })
    .populate('message', 'string')
    .populate('to', 'user')
    .populate('from', 'user')
