...
export default class DislikeController implements DislikeControllerI {
  ...
  /**
   * Toggles dislike button logic.
   * @param req Represents request from client, including the path parameters uid and tid
   * representing the user that is disliking the tuit and the tuit being disliked
   * @param {Response} res Represents response to client, including status
   * on whether deleting the like was successful or not
   */
  userTogglesTuitDisikes = async (req, res) => {
    const uid = req.params.uid;
